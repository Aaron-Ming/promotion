...
class UserRole(models.Model):
    ...
    role_level = models.IntegerField(default=4, verbose_name=u'角色级别',
                                     choices=ROLE_LEVEL)
...
class UserProfile(models.Model):
    ...
    group = models.ForeignKey('UserGroup', verbose_name=u'用户组',
                              related_name='usergroup')
    active = models.BooleanField(default=False, verbose_name=u'用户是否激活')

    id_face = models.ImageField(upload_to=profile_img_path,
                                verbose_name=u'身份证正面',
                                blank=True, null=True)
    id_back = models.ImageField(upload_to=profile_img_path,
                                verbose_name=u'身份证背面',
                                blank=True, null=True)
    license = models.ImageField(upload_to=profile_img_path,
                                verbose_name=u'营业执照',
                                blank=True, null=True)
